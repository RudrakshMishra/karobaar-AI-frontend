        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <button className="w-full py-4 rounded-full border border-white/20 bg-white/5 text-white font-bold hover:bg-white/10 transition-colors">Join Waitlist</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
